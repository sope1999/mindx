...
function getGroupColor(ft){const isLight=document.documentElement.getAttribute('data-theme')==='light';if(isLight){const c={root_index:'#d4e2fc',constitution:'#fde8d0',project_index:'#d4f5d4',project_overview:'#d4f5d4',project_progress:'#c8f0c8',dev_sessions:'#d4e2fc',dev_sessions_old:'#e0e3e8',tool_l2:'#e6d9fc',tool_l3:'#f0e4fc',tool_standalone:'#e4d9f7',archive_index:'#e0e3e8',diary:'#e8e8e8',cheatsheet:'#fde8d0',manual:'#fde8d0',bookmarks:'#fde8d0'};return c[ft]||'#e8e8e8';}const c={root_index:'#1a3a6e',constitution:'#5a2d0a',project_index:'#0f451a',project_overview:'#0f451a',project_progress:'#0d3a18',dev_sessions:'#1a3a6e',dev_sessions_old:'#2a3038',tool_l2:'#3a1e75',tool_l3:'#4d3285',tool_standalone:'#3d2870',archive_index:'#2a3038',diary:'#22262b',cheatsheet:'#5a2d0a',manual:'#5a2d0a',bookmarks:'#5a2d0a'};return c[ft]||'#22262b';}
...
function getNodeColor(ftype,path){const cls=getClassification(path);const isLight=document.documentElement.getAttribute('data-theme')==='light';if(cls==='base')return isLight?'#d4e2fc':'#1a3a6e';if(cls==='standalone')return isLight?'#fde8d0':'#5a2d0a';if(cls==='external')return isLight?'#d3f0f4':'#064d4f';return getGroupColor(ftype);}
