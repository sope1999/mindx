...
function getGroupColor(ft){const isLight=document.documentElement.getAttribute('data-theme')==='light';if(isLight){const c={root_index:'#d4e2fc',constitution:'#fde8d0',project_index:'#d4f5d4',project_overview:'#d4f5d4',project_progress:'#c8f0c8',dev_sessions:'#d4e2fc',dev_sessions_old:'#e0e3e8',tool_l2:'#e6d9fc',tool_l3:'#f0e4fc',tool_standalone:'#e4d9f7',archive_index:'#e0e3e8',diary:'#e8e8e8',cheatsheet:'#fde8d0',manual:'#fde8d0',bookmarks:'#fde8d0'};return c[ft]||'#e8e8e8';}const c={root_index:'#2d5aa0',constitution:'#8b4513',project_index:'#1a6b2a',project_overview:'#1a6b2a',project_progress:'#155a28',dev_sessions:'#2d5aa0',dev_sessions_old:'#404a56',tool_l2:'#5a30b5',tool_l3:'#7550c8',tool_standalone:'#6040b0',archive_index:'#404a56',diary:'#353a44',cheatsheet:'#8b4513',manual:'#8b4513',bookmarks:'#8b4513'};return c[ft]||'#353a44';}
...
function getNodeColor(ftype,path){const cls=getClassification(path);const isLight=document.documentElement.getAttribute('data-theme')==='light';if(cls==='base')return isLight?'#d4e2fc':'#2d5aa0';if(cls==='standalone')return isLight?'#fde8d0':'#8b4513';if(cls==='external')return isLight?'#d3f0f4':'#0d7377';return getGroupColor(ftype);}
